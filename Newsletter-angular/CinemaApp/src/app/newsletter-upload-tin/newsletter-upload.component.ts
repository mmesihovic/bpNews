...
import { UploadServiceTin } from 'src/app/services-tin/upload-service';

@Component({
  selector: 'app-newsletter-upload-tin',
  templateUrl: './newsletter-upload.component.html',
  styleUrls: ['./newsletter-upload.component.css']
})
export class NewsletterUploadComponentTin implements OnInit {
  uploadForm: FormGroup;
  names: Array<String> = new Array<String>();
  
  constructor(private formBuilder: FormBuilder,
              private uploadService: UploadServiceTin) { }
