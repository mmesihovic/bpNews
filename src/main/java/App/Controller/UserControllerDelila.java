...
import App.Entities.*;
import App.Repositories.IFajloviDelila;
...
@Controller
@RequestMapping("delila/api/users")
public class UserControllerDelila {

    @Autowired
    UserService usersService;
    @Autowired
    IFajloviDelila fajloviDelila;

    @RequestMapping(value="/", method = RequestMethod.GET)
    @ResponseBody
    public String showUserFormDelila() {

        return "userForm";
    }

    @CrossOrigin(origins = "http://localhost:4200")
    @RequestMapping(value="/delila/upload", method = RequestMethod.POST)
    @ResponseBody
    public String uploadFileDelila(@RequestParam("firstName") String firstname,
    ...
    @CrossOrigin(origins = "http://localhost:4200")
    @RequestMapping(value="/delila/download", method = RequestMethod.GET)
    @ResponseBody
    public String downloadFile(@RequestParam("fileName") String fileName,
                               @RequestParam("firstName") String firstname,
                               @RequestParam("lastName") String lastname ) {

        FajloviDelila f = new FajloviDelila();
        KorisniciDelila kd = new KorisniciDelila();


        List<FajloviDelila> listaFajlova = (List<FajloviDelila>) fajloviDelila.findAll();
    ...
    @CrossOrigin(origins = "http://localhost:4200")
    @RequestMapping(value="/delila/getFiles", method = RequestMethod.GET)
    @ResponseBody
