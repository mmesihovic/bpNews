alter session set current_schema=bp20;
...
INSERT ALL
  ...
  INTO COMMENTS(AuthorID, PostID, Text, ReplyTo, PublishedAt) VALUES (14, 5, 'Great job by the Tottenham staff.', null, CURRENT_TIMESTAMP)
SELECT * FROM DUAL;
INSERT
  INTO COMMENTS(AuthorID, PostID, Text, ReplyTo, PublishedAt) VALUES (15, 5, 'Great job by the staff? The lad is a luagh.', 8, CURRENT_TIMESTAMP)

/*Insert Users*/
INSERT  ALL
  INTO Users (USERNAME, PASSWORD, MAIL, ROLEID) VALUES ('mmesihovic1', 'mmesihovic1', 'mmesihovic1@etf.unsa.ba', 2)
  INTO Users (USERNAME, PASSWORD, MAIL, ROLEID) VALUES ('ddevic1', 'ddevic1', 'ddevic1@etf.unsa.ba', 2)
  INTO Users (USERNAME, PASSWORD, MAIL, ROLEID) VALUES ('shrenovica1', 'shrenovica1', 'shrenovica1@etf.unsa.ba', 3)
  INTO Users (USERNAME, PASSWORD, MAIL, ROLEID) VALUES ('tvidovic1', 'tvidovic1', 'tvidovic1@etf.unsa.ba', 4)
  INTO Users (USERNAME, PASSWORD, MAIL, ROLEID) VALUES ('aalic6', 'aalic1', 'aalic1@etf.unsa.ba', 1)
  INTO Users (USERNAME, PASSWORD, MAIL, ROLEID) VALUES ('aomerbegovic2', 'aomerbegovic2', 'aomerbegovic2@etf.unsa.ba', 1)
  INTO Users (USERNAME, PASSWORD, MAIL, ROLEID) VALUES ('atucak1', 'atucak1', 'atucak1@etf.unsa.ba', 1)
  INTO Users (USERNAME, PASSWORD, MAIL, ROLEID) VALUES ('nzilic1', 'nzilic1', 'nzilic1@etf.unsa.ba', 4)
SELECT * from dual;
...
ALTER TABLE Posts MODIFY (headpictureid NULL) ;
